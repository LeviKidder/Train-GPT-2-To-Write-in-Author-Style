...
ALL_MODELS = sum((conf for conf in (GPT2Config.get_config_dict("gpt2-medium"), OpenAIGPTConfig.get_config_dict("openai-gpt"))), ())
...
def main():
    ...
    parser.add_argument("--model_type", default='gpt2-medium', type=str, required=True,
